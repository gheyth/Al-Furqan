...
1. داخل مجلد: `content/` يتم انشاء مجلد باسم السورة الانجليزي بحروف صغيرة لا يفصل بين الحروف اي فراغات او محتوى نصي اخر. مثل `mynewsurah`
2. داخل مجلد `surah/`  الذي يكون داخل `pages/surah/` يتم انشاء مجلد باسم السورة الانجليزي بحروف صغيرة لا يفصل بين الحروف اي فراغات او محتوى نصي اخر. مثل `mynewsurah` ويستحسن ان يكون نفس الاسم للسورة هو نفسه بمجلد `content/`
يكون المسار الجديد هكذا:
```
/pages/surah/mynewsurah
```
4. فيما بعد داخل مجلد السورة الجديدة يتم انشاء ملفين يكون اسمهما كالتالي:  `index.vue` و `slug.vue_`
